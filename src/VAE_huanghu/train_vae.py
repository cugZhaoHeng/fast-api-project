...
train_ds = datasets.MNIST(r"D:\git\fast-api-project\data", train=True, download=False, transform=transform)
test_ds = datasets.MNIST(r"D:\git\fast-api-project\data", train=False, download=False, transform=transform)
